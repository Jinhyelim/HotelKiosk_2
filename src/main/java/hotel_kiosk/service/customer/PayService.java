...
public class PayService {
    ...
    public void confirmTossPayment(String paymentKey, String orderId, Long amount, String reservationId, int roomPrice,
        ...
        // 포인트 적립 처리 (사용 포인트도 함께 전달 -> 한 레코드에 INSERT)
        int earnPoint = (int)(amount.intValue() * 0.01);
        earnMemberPoint(memberPhone, memberBirth, memberName, earnPoint, firstIdx, pointAmount);
    }
    ...
    private void earnMemberPoint(String memberPhone, LocalDate memberBirth,
                                 String memberName, int earnPoint, Long idx, int usingPoint) {
        ...
        // 포인트 내역 기록 -> members_point 테이블에 한 레코드로 INSERT (사용 + 적립)
