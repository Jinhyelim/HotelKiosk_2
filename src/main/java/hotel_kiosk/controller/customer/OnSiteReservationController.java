...
public class OnSiteReservationController {
    ...
    public Map<String, Object> preReserve(@RequestBody PreReserveRequestDTO dto) {
        ...
        Members members = Members.builder()
                ...
                .memberBirth(java.time.LocalDate.parse(dto.getMemberBirth()))
                .build();

        Reservations reservations = new Reservations();
        reservations.setCheckinDate(java.time.LocalDate.parse(dto.getCheckinDate()));
        reservations.setCheckoutDate(java.time.LocalDate.parse(dto.getCheckoutDate()));
        ...
        List<String> reservationIds = onSiteReservationService.preRegisterReservation(
                members, reservations, dto.getRoomNos(), dto.getSelectedOptions()
        );
