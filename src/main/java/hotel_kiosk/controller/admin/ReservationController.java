...
import hotel_kiosk.service.admin.MembersPointService;
...
public class ReservationController {
    ...
    public ResponseEntity<PageResponseDTO<ReservationsDTO>> searchCustomer(
        ...
        if (keyword != null && !keyword.isBlank()) {
            ...
            List<ReservationsDTO> byPhone = reservationReadService.readByPhone(keyword);

            result = Stream.of(byName, byId, byPhone)
